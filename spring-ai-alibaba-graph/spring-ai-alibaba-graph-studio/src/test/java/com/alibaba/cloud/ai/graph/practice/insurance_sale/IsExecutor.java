...
public class IsExecutor {
	...
	public enum Serializers {
		...
		private final StateSerializer<IsExecutor.State> serializer;

		Serializers(StateSerializer<IsExecutor.State> serializer) {
			this.serializer = serializer;
		}

		public StateSerializer<IsExecutor.State> object() {
			return serializer;
		}
